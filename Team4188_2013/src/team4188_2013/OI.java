...
public class OI {
    ...
    copilotStick = new CorpsJoystick(2,3,11,-5,5,1,1,-1,1,4,-1,0,0,0,0);
        ...
        copilot11.whenPressed(new IncrementShooter());
        copilot10 = new JoystickButton(copilotStick, 10);
        copilot10.whenPressed(new DecrementShooter());
        ...
        copilot7.whenPressed(new Shoot());
        ...
        copilot1.whileHeld(new HoldShoot());
      ...
      //  SmartDashboard.putData("TurnXDegrees", new TurnXDegrees());
        ...
        SmartDashboard.putData("AdjustThrottle", new AdjustThrottle());
        SmartDashboard.putData("IncrementShooter", new IncrementShooter());
        SmartDashboard.putData("DecrementShooter", new DecrementShooter());
