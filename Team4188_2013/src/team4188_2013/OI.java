...
public class OI {
    ...
    //double turnAngle = SmartDashboard.getNumber("TurnAngle");
    ...
    public OI() {
        ...
        //double tiltAngle = Robot.shooter.getTiltAngle();
       ...
       // copilotStick = new CorpsJoystick(2);
        ...
        copilot10.whenPressed(new LoadFrisbee());
        ...
        copilot2.whileHeld(new BackUpClimb());
        copilot1 = new JoystickButton(copilotStick, 1);
        copilot1.whenPressed(new SafeShoot());
       // pilotStick = new CorpsJoystick(1);
        ...
        SmartDashboard.putData("LightsToggle", new LightsToggle());
        SmartDashboard.putData("SafeShoot", new SafeShoot());
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        //copilot1.whenReleased(new RetractPusher());
        //copilot5.whenPressed(new TiltYDegrees(30.0));
        copilot11.whenPressed(new TiltYDegrees(Robot.shooter.getBackLeft())); //back
        copilot8.whileHeld(new DisableCompressor());
        copilot8.whenReleased(new EnableCompressor()); 
        pilot6.whenPressed(new TiltYDegrees(Robot.shooter.getFrontRight())); //front
        pilot5.whenPressed(new TiltYDegrees(Robot.shooter.getFrontLeft())); //front
        pilot4.whenPressed(new TiltYDegrees(Robot.shooter.getBackRight())); //back
        pilot3.whenPressed(new TiltYDegrees(Robot.shooter.getBackLeft())); //back
        pilot1.whenPressed(new TiltYDegrees(Robot.shooter.getMiddle())); //middle
    }
