...
public class RobotMap {
    ...
    public static AnalogChannel drivetrainTemperature;
    ...
    public static DigitalInput climbersliderIn;
    public static DigitalInput climbersliderOut;
    ...
    public static void init() {
        ...
        drivetrainTemperature = new AnalogChannel(1, 2);
	LiveWindow.addSensor("Drivetrain", "Temperature", drivetrainTemperature);
	...
	LiveWindow.addActuator("Shooter", "frisbeePushSol", shooterfrisbeePushSol);
        ...
        shootertiltPot = new AnalogChannel(1, 3);
	...
	LiveWindow.addSensor("Climber", "tallTopOut", climbertallTopOut);
        ...
        climbersliderIn = new DigitalInput(1, 2);
	LiveWindow.addSensor("Climber", "sliderIn", climbersliderIn);
        
        climbersliderOut = new DigitalInput(1, 3);
