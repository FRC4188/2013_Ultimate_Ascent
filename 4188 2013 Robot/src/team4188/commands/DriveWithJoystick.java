...
public class DriveWithJoystick extends CommandBase {
    ...
    protected void execute() {
        ...
        drivetrain.Drive.mecanumDrive_Cartesian((oi.getJoystick().getX())*-1*oi.stick.getThrottle(),oi.getJoystick().getY()*oi.stick.getThrottle(),oi.getJoystick().getTwist()*-1*oi.stick.getThrottle(), direction);
